...
import type { EntityIdentifier } from '@gitkraken/provider-apis/dist/types/exportedTypes/types';
...
export function getEntityIdentifier(issueOrPullRequest: IssueOrPullRequest): EntityIdentifier | undefined {
